...
import type { MessagePayload, MessageTypes } from '~/models/message.model';
...
>(types: T | T[], callback: ChromeMessageListener<T, P, R>) {
  return onMessageEvent<T, P, R>(callback, types);
}
...
export async function sendMessage<
  ...
  R extends ChromeResponsePayload = ChromeResponsePayload,
  P extends MessagePayload = MessagePayload<T>,
>(message: ChromeMessage<T, P>, options?: ChromeMessageOptions) {
